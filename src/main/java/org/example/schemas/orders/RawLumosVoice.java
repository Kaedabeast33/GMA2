...
@KdbTable(
        description = "Table storing raw Lumos voice order records",
        name = "raw_lumos_voice",
        tags = {"orders", "lumos", "voice", "raw"},
        type = ""
)
@Component
public class RawLumosVoice {
