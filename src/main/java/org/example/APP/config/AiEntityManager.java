...
public class AiEntityManager {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryAi(
            EntityManagerFactoryBuilder builder,
            @Qualifier("dataSourceAi") DataSource dataSource) {
        ...
        return builder
                ...
                .persistenceUnit("entityManagerFactoryAi")
    ...
    @Bean(name = "transactionManagerAi")
    public PlatformTransactionManager transactionManagerAi(@Qualifier("entityManagerFactoryAi") LocalContainerEntityManagerFactoryBean entityManagerFactory) {
