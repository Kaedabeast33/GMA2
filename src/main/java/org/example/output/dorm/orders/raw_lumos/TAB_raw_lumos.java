package org.example.output.dorm.orders.raw_lumos;
...
import org.example.output.dorm.orders.raw_lumos.columns.COL_db_id;
import org.example.output.dorm.orders.raw_lumos.columns.COL_wtn;
import org.example.output.dorm.orders.raw_lumos.columns.COL_account_number;
import org.example.output.dorm.orders.raw_lumos.columns.COL_add_ons;
import org.example.output.dorm.orders.raw_lumos.columns.COL_appointment_date;
import org.example.output.dorm.orders.raw_lumos.columns.COL_city;
import org.example.output.dorm.orders.raw_lumos.columns.COL_columns;
import org.example.output.dorm.orders.raw_lumos.columns.COL_create_date;
import org.example.output.dorm.orders.raw_lumos.columns.COL_create_time;
import org.example.output.dorm.orders.raw_lumos.columns.COL_customer_name;
import org.example.output.dorm.orders.raw_lumos.columns.COL_internet_product_family;
import org.example.output.dorm.orders.raw_lumos.columns.COL_internet_product_name;
import org.example.output.dorm.orders.raw_lumos.columns.COL_internet_quantity;
import org.example.output.dorm.orders.raw_lumos.columns.COL_order_number;
import org.example.output.dorm.orders.raw_lumos.columns.COL_order_status;
import org.example.output.dorm.orders.raw_lumos.columns.COL_order_type;
import org.example.output.dorm.orders.raw_lumos.columns.COL_partner_id;
import org.example.output.dorm.orders.raw_lumos.columns.COL_partner_name;
import org.example.output.dorm.orders.raw_lumos.columns.COL_partner_reference_id;
import org.example.output.dorm.orders.raw_lumos.columns.COL_pops_order_id;
import org.example.output.dorm.orders.raw_lumos.columns.COL_port;
import org.example.output.dorm.orders.raw_lumos.columns.COL_sales_code;
import org.example.output.dorm.orders.raw_lumos.columns.COL_sales_person_id;
import org.example.output.dorm.orders.raw_lumos.columns.COL_sales_person_name;
import org.example.output.dorm.orders.raw_lumos.columns.COL_sales_person_username;
import org.example.output.dorm.orders.raw_lumos.columns.COL_state;
import org.example.output.dorm.orders.raw_lumos.columns.COL_status_change_date;
import org.example.output.dorm.orders.raw_lumos.columns.COL_street_address;
import org.example.output.dorm.orders.raw_lumos.columns.COL_subcategory_id;
import org.example.output.dorm.orders.raw_lumos.columns.COL_subcategory_name;
import org.example.output.dorm.orders.raw_lumos.columns.COL_subcategory_username;
import org.example.output.dorm.orders.raw_lumos.columns.COL_unit;
import org.example.output.dorm.orders.raw_lumos.columns.COL_voice_product_family;
import org.example.output.dorm.orders.raw_lumos.columns.COL_voice_product_name;
import org.example.output.dorm.orders.raw_lumos.columns.COL_voice_quantity;
import org.example.output.dorm.orders.raw_lumos.columns.COL_wifi_product_family;
import org.example.output.dorm.orders.raw_lumos.columns.COL_wifi_product_name;
import org.example.output.dorm.orders.raw_lumos.columns.COL_wifi_quantity;
import org.example.output.dorm.orders.raw_lumos.columns.COL_zip_code;
import org.example.output.dorm.orders.raw_lumos.columns.COL_latest_insert_date;
import org.example.output.dorm.orders.raw_lumos.columns.COL_employee_id;
import org.example.output.dorm.orders.raw_lumos.columns.COL_manual_employee_id;

import java.util.List;

import org.example.ContextInstance.KDBContext;

public class TAB_raw_lumos extends TableTemplate {

    public TAB_raw_lumos() {
        super(
            "raw_lumos"
,
            "Table storing raw Lumos order records"
,
            new String[]{"orders", "lumos", "raw"},
            "tab5874298b-3f32-4c8a-9615-b5aae44518bd"
,
            "dorm"
,
            "orders"
 ...
 KDBContext context = KDBContext.KDB_CONTEXT;
    ...
    private final ColumnTemplate COL_add_ons = new COL_add_ons();

    public ColumnTemplate getCOL_add_ons() {
        return COL_add_ons;
    }
    ...
    private final ColumnTemplate COL_wifi_product_family = new COL_wifi_product_family();

    public ColumnTemplate getCOL_wifi_product_family() {
        return COL_wifi_product_family;
    }
    ...
    private final ColumnTemplate COL_wifi_product_name = new COL_wifi_product_name();

    public ColumnTemplate getCOL_wifi_product_name() {
        return COL_wifi_product_name;
    }
    ...
    private final ColumnTemplate COL_wifi_quantity = new COL_wifi_quantity();

    public ColumnTemplate getCOL_wifi_quantity() {
        return COL_wifi_quantity;
    }
...
public String getValues()  {
    return String.format("('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')\n",
          ...
          getCOL_add_ons().getEntityValue().getValue().toString(),
          ...
          getCOL_wifi_product_family().getEntityValue().getValue().toString(),
          getCOL_wifi_product_name().getEntityValue().getValue().toString(),
          getCOL_wifi_quantity().getEntityValue().getValue().toString(),
