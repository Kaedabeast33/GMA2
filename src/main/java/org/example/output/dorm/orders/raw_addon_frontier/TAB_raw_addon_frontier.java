package org.example.output.dorm.orders.raw_addon_frontier;
...
import org.example.output.dorm.orders.raw_addon_frontier.columns.COL_db_id;
import org.example.output.dorm.orders.raw_addon_frontier.columns.COL_account_number;
import org.example.output.dorm.orders.raw_addon_frontier.columns.COL_addon;
import org.example.output.dorm.orders.raw_addon_frontier.columns.COL_date_db_changed;
import org.example.output.dorm.orders.raw_addon_frontier.columns.COL_mobile_number;
import org.example.output.dorm.orders.raw_addon_frontier.columns.COL_order_id;
import org.example.output.dorm.orders.raw_addon_frontier.columns.COL_order_number;
import org.example.output.dorm.orders.raw_addon_frontier.columns.COL_carrier_system;

import java.util.List;

import org.example.ContextInstance.KDBContext;

public class TAB_raw_addon_frontier extends TableTemplate {

    public TAB_raw_addon_frontier() {
        super(
            "raw_addon_frontier"
,
            "Table storing raw Frontier addon records"
,
            new String[]{"orders", "addon", "frontier"},
            "tab3cf27d9c-2b86-4f60-aaaa-300a44bddb52"
,
            "dorm"
,
            "orders"
