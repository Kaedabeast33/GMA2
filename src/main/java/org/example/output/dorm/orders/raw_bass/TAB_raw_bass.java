package org.example.output.dorm.orders.raw_bass;
...
import org.example.output.dorm.orders.raw_bass.columns.COL_account_number;
import org.example.output.dorm.orders.raw_bass.columns.COL_bass_order_id;
import org.example.output.dorm.orders.raw_bass.columns.COL_billing_number;
import org.example.output.dorm.orders.raw_bass.columns.COL_city;
import org.example.output.dorm.orders.raw_bass.columns.COL_create_time;
import org.example.output.dorm.orders.raw_bass.columns.COL_customer_name;
import org.example.output.dorm.orders.raw_bass.columns.COL_customer_type;
import org.example.output.dorm.orders.raw_bass.columns.COL_due_date;
import org.example.output.dorm.orders.raw_bass.columns.COL_internet_action_code;
import org.example.output.dorm.orders.raw_bass.columns.COL_internet_product_family;
import org.example.output.dorm.orders.raw_bass.columns.COL_internet_product_name;
import org.example.output.dorm.orders.raw_bass.columns.COL_internet_product_status;
import org.example.output.dorm.orders.raw_bass.columns.COL_internet_quantity;
import org.example.output.dorm.orders.raw_bass.columns.COL_internet_usoc;
import org.example.output.dorm.orders.raw_bass.columns.COL_master_agent_id;
import org.example.output.dorm.orders.raw_bass.columns.COL_master_agent_name;
import org.example.output.dorm.orders.raw_bass.columns.COL_order_number;
import org.example.output.dorm.orders.raw_bass.columns.COL_order_status;
import org.example.output.dorm.orders.raw_bass.columns.COL_order_type;
import org.example.output.dorm.orders.raw_bass.columns.COL_outside_sales_rep;
import org.example.output.dorm.orders.raw_bass.columns.COL_partner_reference_id;
import org.example.output.dorm.orders.raw_bass.columns.COL_regional_sales_manager;
import org.example.output.dorm.orders.raw_bass.columns.COL_sales_code;
import org.example.output.dorm.orders.raw_bass.columns.COL_sales_person_id;
import org.example.output.dorm.orders.raw_bass.columns.COL_sales_person_name;
import org.example.output.dorm.orders.raw_bass.columns.COL_sales_persons_username;
import org.example.output.dorm.orders.raw_bass.columns.COL_state;
import org.example.output.dorm.orders.raw_bass.columns.COL_status_change_date;
import org.example.output.dorm.orders.raw_bass.columns.COL_street_address;
import org.example.output.dorm.orders.raw_bass.columns.COL_sub_agent_name;
import org.example.output.dorm.orders.raw_bass.columns.COL_sub_agent_username;
import org.example.output.dorm.orders.raw_bass.columns.COL_subagent_id;
import org.example.output.dorm.orders.raw_bass.columns.COL_type_of_sale;
import org.example.output.dorm.orders.raw_bass.columns.COL_unit;
import org.example.output.dorm.orders.raw_bass.columns.COL_wtn;
import org.example.output.dorm.orders.raw_bass.columns.COL_zip_code;
import org.example.output.dorm.orders.raw_bass.columns.COL_latest_insert_date;
import org.example.output.dorm.orders.raw_bass.columns.COL_db_id;
import org.example.output.dorm.orders.raw_bass.columns.COL_dsl_migrator;
import org.example.output.dorm.orders.raw_bass.columns.COL_employee_id;
import org.example.output.dorm.orders.raw_bass.columns.COL_manual_employee_id;

import java.util.List;

import org.example.ContextInstance.KDBContext;

public class TAB_raw_bass extends TableTemplate {

    public TAB_raw_bass() {
        super(
            "raw_bass"
,
            "Table storing raw BASS order records"
,
            new String[]{"orders", "bass", "raw"},
            "tabb6fc9731-8eeb-41ca-b115-00efa6b193be"
,
            "dorm"
,
            "orders"
 ...
 KDBContext context = KDBContext.KDB_CONTEXT;
    ...
    private final ColumnTemplate COL_bass_order_id = new COL_bass_order_id();

    public ColumnTemplate getCOL_bass_order_id() {
        return COL_bass_order_id;
    }
    ...
    private final ColumnTemplate COL_sales_persons_username = new COL_sales_persons_username();

    public ColumnTemplate getCOL_sales_persons_username() {
        return COL_sales_persons_username;
    }
    ...
    private final ColumnTemplate COL_dsl_migrator = new COL_dsl_migrator();

    public ColumnTemplate getCOL_dsl_migrator() {
        return COL_dsl_migrator;
    }
...
public String getValues()  {
    return String.format("('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')\n",
          ...
          getCOL_bass_order_id().getEntityValue().getValue().toString(),
          ...
          getCOL_sales_persons_username().getEntityValue().getValue().toString(),
          ...
          getCOL_dsl_migrator().getEntityValue().getValue().toString(),
