package org.example.output.dorm.orders.raw_bass_voice;
...
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_account_number;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_bass_order_id;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_city;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_create_time;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_customer_name;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_due_date;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_latest_insert_date;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_local_product_family;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_local_product_name;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_local_product_status;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_local_quantity;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_master_agent_id;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_master_agent_name;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_order_number;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_order_status;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_partner_reference_id;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_sales_person_id;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_sales_person_name;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_sales_persons_username;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_state;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_status_change_date;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_street_address;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_sub_agent_name;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_sub_agent_username;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_subagent_id;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_type_of_sale;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_unit;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_wtn;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_zip_code;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_db_id;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_dsl_migrator;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_employee_id;
import org.example.output.dorm.orders.raw_bass_voice.columns.COL_manual_employee_id;

import java.util.List;

import org.example.ContextInstance.KDBContext;

public class TAB_raw_bass_voice extends TableTemplate {

    public TAB_raw_bass_voice() {
        super(
            "raw_bass_voice"
,
            "Table storing raw BASS voice order records"
,
            new String[]{"orders", "bass", "voice", "raw"},
            "tab916fdac8-3899-4a17-820c-f3fe5b0dc810"
,
            "dorm"
,
            "orders"
...
public String getValues()  {
    return String.format("('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')\n",
