package org.example.output.dorm.orders.raw_addon_metronet;
...
import org.example.output.dorm.orders.raw_addon_metronet.columns.COL_db_id;
import org.example.output.dorm.orders.raw_addon_metronet.columns.COL_account_number;
import org.example.output.dorm.orders.raw_addon_metronet.columns.COL_addon;
import org.example.output.dorm.orders.raw_addon_metronet.columns.COL_carrier_system;
import org.example.output.dorm.orders.raw_addon_metronet.columns.COL_date_db_changed;
import org.example.output.dorm.orders.raw_addon_metronet.columns.COL_mobile_number;
import org.example.output.dorm.orders.raw_addon_metronet.columns.COL_order_id;
import org.example.output.dorm.orders.raw_addon_metronet.columns.COL_order_number;

import java.util.List;

import org.example.ContextInstance.KDBContext;

public class TAB_raw_addon_metronet extends TableTemplate {

    public TAB_raw_addon_metronet() {
        super(
            "raw_addon_metronet"
,
            "Table storing raw Metronet addon records"
,
            new String[]{"orders", "addon", "metronet"},
            "tab0a49edd6-39dc-40e2-a2c4-a71a9856c807"
,
            "dorm"
,
            "orders"
