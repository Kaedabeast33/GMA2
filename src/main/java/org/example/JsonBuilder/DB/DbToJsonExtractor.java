...
import org.example.JsonBuilder.IDE.json.ma.tables.ProcedureJson;
import org.example.JsonBuilder.IDE.json.ma.tables.TableJson;
import org.example.JsonBuilder.IDE.json.ma.tables.TriggerJson;
import org.example.JsonBuilder.IDE.json.ma.tables.UniqueKeyJson;
import org.example.JsonBuilder.IDE.json.ma.tables.columns.ColumnDTO;
import org.example.JsonBuilder.IDE.json.ma.tables.columns.ColumnJson;
import org.example.JsonBuilder.IDE.json.ma.tables.columns.IndexJson;
...
public class DbToJsonExtractor {
     ...
     */
    public static List<org.example.JsonBuilder.IDE.json.ma.tables.TableJson> extractTables(Connection conn, String databaseName) throws SQLException, InvocationTargetException, IllegalAccessException {
//        System.out.println("Starting table extraction for database: " + databaseName);
        DatabaseMetaData metaData = conn.getMetaData();
        List<org.example.JsonBuilder.IDE.json.ma.tables.TableJson> tables = new ArrayList<>();
...
//            System.out.println("Found table: " + tableName);
            ...
            org.example.JsonBuilder.IDE.json.ma.tables.TableJson table = new TableJson();
