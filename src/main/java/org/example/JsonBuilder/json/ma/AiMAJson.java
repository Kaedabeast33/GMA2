...
public class AiMAJson {
    ...
    public AiMAJson(Identifier identifier, MAConfigTemplate db) {
    ...
    public void setTables(AiTableJson[] aiTableJsons) {
    }
