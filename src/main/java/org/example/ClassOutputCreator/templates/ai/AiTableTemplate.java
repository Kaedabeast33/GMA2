...
import org.example.bank.OutputClassBank.AiTableInterface;
...
public abstract class AiTableTemplate implements AiTableInterface {
...
//    protected final List<AiColumnTemplate> indexColumns;
//
//
//
...
//
//
//    public AiTableTemplate(String name, String description, String[] tag,String gmaName, String maName, List<AiColumnTemplate> indexColumns) {
//        this.name = name;
...
//
//
//    public List<AiColumnTemplate> getAllCollumns() {
//        return List.of();
//    }
//
//
...
//    }
//
//    public abstract List<AiColumnTemplate> getAllColumns();
